...
/* harmony import */ var _utils_string__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/string */ "./resources/js/utils/string.js");
/* harmony import */ var _role_menu_item_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./role-menu-item.vue */ "./resources/js/Pages/RolMenu/role-menu-item.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 14:
              ...
              if (_context.t0 !== null && _context.t0 !== void 0 && (_err$response = _context.t0.response) !== null && _err$response !== void 0 && (_err$response$data = _err$response.data) !== null && _err$response$data !== void 0 && _err$response$data.server) {
                ...
                Swal.fire({
                  title: 'Error!',
                  text: msg + '\n' + (0,_utils_string__WEBPACK_IMPORTED_MODULE_4__.truncarTexto)(_message),
                  icon: 'error'
                });
              }
            case 18:
    ...
    var __returned__ = {
      ...
      get truncarTexto() {
        return _utils_string__WEBPACK_IMPORTED_MODULE_4__.truncarTexto;
      },
      RoleMenuItem: _role_menu_item_vue__WEBPACK_IMPORTED_MODULE_5__["default"]
    };
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var inputForm = (0,_inertiajs_inertia_vue3__WEBPACK_IMPORTED_MODULE_0__.useForm)({
      selectedRolMenu: [],
      rol_id: 0,
      menu_id: 0,
      state: 0
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 1;
              _context2.next = 4;
              return axios__WEBPACK_IMPORTED_MODULE_1___default().post(route('rol-menu.store'), inputForm);
            case 4:
