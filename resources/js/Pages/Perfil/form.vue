          ...
          <v-form @submit="validateForm" ref="form" lazy-validation>
            <v-row class="justify-center">
              <v-col cols="12" sm="8" md="6">
                <v-img v-if="inputForm.imagenFile" :src="previewImage(inputForm.imagenFile)" max-width="150"
                  max-height="150" class="d-block mx-auto" />
            ...
            <v-row class="row-gap-2">
              <v-col cols="12" md="4" sm="6">
                <v-text-field id="Numero de Documento" name="Numero de Documento" label="Numero de Documento"
                  v-model="inputForm.dni" color="input" disabled :rules="validate('dni', 'required')"
                  :error-messages="inputForm.errors.dni" prepend-inner-icon="mdi-lock-outline" /></v-col>
              <v-col cols="12" md="4" sm="6">
                <v-text-field id="email" name="email" label="email" v-model="inputForm.email" color="input" disabled
                  :rules="validate('email', 'required')" :error-messages="inputForm.errors.email"
                  prepend-inner-icon="mdi-lock-outline" />
              </v-col>
              <v-col cols="12" md="4" sm="6">
                <v-text-field id="telefono" name="telefono" label="Telefono" v-model="inputForm.telefono" color="input"
                  :disabled="isDisabled" :rules="validate('Telefono', 'required')"
            ...
            <v-row>
              ...
              <v-col cols="12" md="4" sm="6">
                <v-text-field id="fecha_nacimiento" name="fecha_nacimiento" label="Fecha de nacimiento"
                  v-model="inputForm.fecha_nacimiento" color="input" type="date" :disabled="isDisabled"
              ...
              <v-col cols="12" md="4" sm="6">
                <v-text-field id="ocupacion" name="ocupacion" label="Ocupación" v-model="inputForm.ocupacion"
                  color="input" :disabled="isDisabled" :error-messages="inputForm.errors.ocupacion" />
              </v-col>
            </v-row>
            <v-row no-gutters>
              <v-col>
            ...
            <v-row>
              ...
              <v-col cols="12" md="4" sm="6">
                <v-text-field id="ciudad" name="ciudad" label="Ciudad/Comuna" v-model="inputForm.ciudad" color="input"
                  :disabled="isDisabled" :error-messages="inputForm.errors.ciudad" clearable />
              </v-col>
              <v-col cols="12" md="4" sm="6">
            ...
            <v-row>
              ...
              <v-col cols="12" md="4" sm="6">
                <v-text-field id="repitaContrasena" name="repitaContrasena" label="Repita Contraseña"
                  placeholder="Repita Nueva Contraseña" v-model="inputForm.repitaContrasena" color="input"
                  type="password" :disabled="isDisabled" :error-messages="inputForm.errors.repitaContrasena" clearable
                  autocomplete="off" />
