    ...
    <MainLayout>
        <v-container fluid>
            <v-card color="background" class="shadow-md px-4 py-2">
                ...
                <v-data-table :headers="headers" :header-props="{ class: 'bg-data-table-header' }"
                    :items="inscripciones" class="elevation-1 rounded bg-data-table-body" hide-default-footer>
