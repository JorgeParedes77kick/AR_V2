...
<template>
  <v-row justify="end" align="center">
    ...
    <v-col cols="5" sm="3" md="2" lg="2" class="d-flex justify-end justify-md-start justify-lg-start justify-xl-start">
      <v-select id="perPageSelect" class="select-paginate" :items="[10, 25, 50, 100]" variant="outlined"
        density="compact" v-model="perPage" hide-details style="max-width: 6rem;" @update:modelValue=updatePerpage />
    </v-col>
    <v-col cols="9" md="6" lg="4" xl="2" class="d-flex justify-end">
      <v-pagination v-model="current" :length="last_page" :total-visible="6" @update:modelValue=updateModelPaginate
        size="small" />
    </v-col>
  </v-row>
